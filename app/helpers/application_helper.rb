module ApplicationHelper
  ...
  def truncate_spec(loc)
    loc.gsub!(/academic/i, "Acad.")
    loc.gsub!(/associate/i, "Ass.")
    loc.gsub!(/science/i, "sci.")
    loc.gsub!(/director/i, "dir.")
    loc.gsub!(/doctor/i, "dr.")
    loc.gsub!(/medical/i, "Med.")
    loc.gsub!(/\sfor\s/i, " ")
    loc.gsub!(/functional/i, "func.")
    loc.gsub!(/hospital/i, "Hosp.")
    loc.gsub!(/electrophysiology/i, "electrophys.")
    loc.gsub!(/imaging/i, "im.")
