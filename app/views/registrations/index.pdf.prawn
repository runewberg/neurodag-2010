...
options = {:line_height => 11, :font_size => "0.8em", :table_font_size => "0.6em", :table_line_height => 23, :start_page_ypos => 24, :table_default_cell_width => 50}  
...
html = render :partial => 'pdf_registrations'
